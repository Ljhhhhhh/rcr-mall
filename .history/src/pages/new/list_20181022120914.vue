<template>
  <div class="container" ref="container">
    ...
    <div class="orderby-select_box van-hairline--bottom">
      <span :ref="'select'+index" v-for="(select, index) in selectList" :key="index" :class="{'selected': index===currentOpenSelect}" @click="changeSelect(index)">
        <em>{{select.name}}</em>
      ...
      <transition name="topin">
        <div class="orderby-select_option" v-show="currentOpenSelect>-1">
          <template v-for="(select, index) in selectList">
            <ul :class="selectList[currentOpenSelect].class" v-show="index===currentOpenSelect && selectList[currentOpenSelect].name!=='品牌'" :key="index">
              <li v-for="(option, i) in currentOptions" :key="i" :class="{selected:index===option.active}" class="van-hairline--bottom">
                ...
                <van-icon color="#0198E7" name="success" v-show="index===option.active" />
              </li>
            </ul>
            <div class="brandScrollWrap" ref="brandBox" v-show="index===currentOpenSelect && selectList[currentOpenSelect].name==='品牌'" :key="index">
...
export default {
  ...
  methods: {
    ...
    async getBrandList() {
      ...
      let selectHeight = this.$refs.select0.offsetHeight;
