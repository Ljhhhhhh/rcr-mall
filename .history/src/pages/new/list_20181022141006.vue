      ...
      <transition name="topin">
        <div class="orderby-select_option" v-show="currentOpenSelect>-1">
          <template v-for="(select, index) in selectList">
            <ul :class="select.class" v-show="index===currentOpenSelect && currentOpenSelect !== 1" :key="select.name">
            ...
            <div class="brandScrollWrap" id="brandBox" v-show="currentOpenSelect === 1" :key="index">
