<template>
  <div class="container">
    ...
    <div class="orderby-select_box van-hairline--bottom">
      ...
      <div class="orderby-select_option" v-show="currentOpenSelect>-1">
        <template v-for="(select, index) in selectList">
          <ul class="orderby-select_default" v-if="index===currentOpenSelect" :key="index">
            <li v-for="(option, index) in currentOptions" :key="index" :class="{selected:index===option.active}">
    ...
    <transition name="van-fade">
      <div class="modal" v-show="currentOpenSelect>0">Fade</div>
    </transition>
