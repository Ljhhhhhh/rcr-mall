<template>
  <div class="container">
    ...
    <div class="orderby-select_box van-hairline--bottom">
      <span v-for="(select, index) in selectList" :key="index" :class="{selected: index===currentOpenSelect}">
        <em>{{select.name}}</em>
        <i class="triangle-down_icon"  :class="{turn_up: index===currentOpenSelect}"></i>
      </span>
