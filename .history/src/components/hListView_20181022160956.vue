<template>
  <h-scroll class="listview" :arr="data" ref="listview" @scroll="scroll" :listenScroll="listenScroll" :probeType="probeType">
    <ul>
      <li v-for="group in arr" :key="group.title" class="list-group" ref="listGroup">
